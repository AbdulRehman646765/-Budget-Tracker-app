...
export const Subscriptions: React.FC<SubscriptionsProps> = ({
  ...
  return (
    <section className="glass-card subscriptions-section tool-card" id="subscriptionsSection">
      <div className="section-title-row">
        <h2><i className="fa-solid fa-calendar-check"></i> Subscriptions & Recurring Bills</h2>
          ...
          subscriptions.map((sub) => (
            <div className="sub-card" key={sub.id}>
              <div className="sub-info">
                <div className="sub-icon"><i className="fa-solid fa-receipt"></i></div>
              ...
              <div className="sub-right">
                <span className="sub-amount">{currency} {sub.amount.toLocaleString()}</span>
                <button
                ...
                <button className="sub-delete-btn" onClick={() => onDelete(sub.id)} title="Delete">
